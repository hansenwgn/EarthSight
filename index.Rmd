...
---
class: inverse, center, middle
# Calling for a pipeline through the analysis
...
- Inflexibility in both time and space:
  ...
  - if we shift the area of interest,
...
## Are information gaps "closed"? - dealing with probability
 ...
 ### What if ——
 somehow we neglected a 99%-likely flood location and instead sent all our response team to an 80%-likely flood location?
...
### The trikiness of dealing with probability
  ...
  - Or should we design a hierarchy of response priority considering both likelihood and potential harm?
...
## Risks of Real-time monitoring 
 ...
 - ### Accuracy management in estimating response time consumed by 
  - Data collection
  - Data transmission
  - Calculation
  - Human-based decision-making.
  
  ### Incurs extra cost and the result is almost always NOT deterministic.
...
---
## AIoT comes to aid
Connect remote-sensing devices to the IoT network, enabling seamless data flow between
 - Devices
 - Edge computing nodes
 - Cloud platforms
 
Using communication protocols such as MQTT, LoRaWAN, or Zigbee.
...
With ground truth data continuously provided by IoT devices, models are evaluated and calibrated by:
 ...
 - Feedbacks from decision-making centre and human 

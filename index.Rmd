...
- To make policies implementable
  ...
  - Work on the chaining of function modules and potential automisation
  give prototypes explore how can EO data and remote sensing facilitate
- How these facilitate minimising risks for people, governments and more

---
## Flood risk management —— Flood prediction
### Machine Learning based multifactor-considering blackbox
...
### Pros and cons of flood prediction
| Pros | Cons |
| --- | --- |
